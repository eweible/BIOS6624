...
fig2 <- ggplot(plot_long2, aes(x = rho_high, y = power, color = alpha_type)) +
  ...
  scale_color_manual(
    values = c(
      "0.05/4" = "#053061",  # dark blue (strict)
      "0.05/6"  = "#4393c3",  # medium blue
      "0.05/24"  = "#d6604d"   # orange/red (overall)
    )
  ) +
  theme_minimal(base_size = 14) +
  theme(
