...
As Aim 2 focused on a continuous/continuous interaction, amyloid deposition was conservatively simplified to dichotomous: positive or negative. Power calculations varied the correlation in the amyloid+ group ($\rho_{high}$ = 0.2-0.7), the difference between amyloid groups ($\Delta \rho$ = 0.1-0.5), and the amyloid prevalence ratio (30/70, 40/60, 50/50, 60/40). These scenarios reflected a range of biologically plausible interaction effects and group distributions. 
