...
Because only one participant in the hard‑drug‑use group had adherence <95%, we conducted a sensitivity analysis using an alternative adherence grouping (<100% vs. 100%) to ensure that sparse data did not distort the adherence‑adjusted estimates. This alternative definition increased the number of individuals classified as having suboptimal adherence from 1 to 18 within the hard‑drug‑use group, improving model stability. The Bayesian posterior means, HPDIs, and posterior probabilities under this alternative specification were nearly identical to those obtained using the investigator‑specified <95% cutoff, and the corresponding frequentist estimates showed the same pattern. Across all outcomes, the direction, magnitude, and uncertainty of the adherence‑adjusted associations changed only trivially, and the substantive interpretation remained unchanged. These findings indicate that the adherence definition does not materially influence the estimated relationship between hard drug use and year‑2 clinical outcomes, and we therefore retained the investigator‑requested adherence grouping for consistency with the study protocol.

## Results

*Table 1* summaries key variables in the final sample of 463 at baseline across baseline hard drug use. *Table 2* summarizes key variables at year 2 across baseline hard drug use. *Figure 1* visualizes the distributions of year 2 outcomes by hard drug status. 

The modeling outcomes are summarized in *Table 3*. The frequentist and Bayesian outcomes agree well, so only Bayesian outcomes will be stated in the text. For viral load, the posterior mean for the association with baseline hard drug use was -0.058 with a 95\% HPDI of (-0,446, 0.342), indicating substantial posterior uncertainty and little evidence of a clinically meaningful effect, defined as a 0.5 log10 change. This is supported by the posterior probability of 0.016, which suggests that there was little support for a harmful association. For CD4+ T cell count, the posterior mean was -163.5 cells (95\% HPDI: (-225.5, -100.7)). The posterior probability that the effect was negative was 1.00, strongly indicating a reduction in CD4 T cell count among individuals who reported baseline hard drug use. This reduction was clinically meaningful, as both sides of the 95\% HPDI are greater than 50 cells. Differences in quality of life scores are defined as clinically meaningful when there is a change of 2 points. For physical quality of life, the posterior mean was -3.34 with a 95\% HPDI of (-6.02, -0.64). Along with the posterior probability of 0.836, there is moderate evidence of reduced physical quality of life among those who reported hard drug use. In contrast, for mental quality of life, the posterior mean (-0.29, 95\% HPDI: (-3.87, 3.05)) and posterior probability (0.265) do not provide strong evidence of any association. 

Adjustments for adherence produced minimal changes in the Bayesian estimates for most outcomes, and the posterior distributions remained aligned with the frequentist results (*Table 4*). For viral load, the adherence-adjusted posterior mean was attenuated by 77% from -0.058 to -0.013 (95\% HPDI: -0.416, 0.386) and the posterior probability remained low (0.014). These results maintain the conclusion that there is little support for any association between hard drug use and viral load regardless of the adherence adjustment. For CD4+ T cell count, the adherence-adjusted posterior mean differed by only -3.8% and the posterior probability remained 1.00. This continues to support the conclusion that there was a reduction in CD4+ T cell count at year 2 among baseline hard drug users and that adherence does not explain the observed association. For physical quality of life, the posterior mean had a 6% change from the unadjusted model, and the posterior probability only modestly increased to 0.866 from 0.836, continuing to provide evidence for lower second year physical quality of life scores among baseline hard drug users. However, the small shifts do not suggest that adherence accounts for much of this association. For mental quality of life, the adherence-adjusted posterior mean was attenuated by 81% relative to the unadjusted model from -0.29 to -0.52 (95\% HPDI: (-4.15, 2.78)). However, the posterior probability remained low (0.275), indicating little support for an association between hard drug use and mental quality of life regardless of the adherence adjustment. 

*Figure 2* visually shows the agreement between the frequentist and Bayesian approaches with and without adherence included in the model. 

## Discussion

Baseline hard drug use was associated with substantially lower CD4+ T cell counts and moderately lower physical quality‑of‑life scores at year 2, after adjusting for baseline covariates. Associations with viral load and mental quality‑of‑life were small and highly uncertain. These results were consistent across Bayesian and frequentist models, and the posterior probabilities indicated strong support only for the CD4+ association. Incorporating second year adherence into the models produced minimal changes in effect estimates or uncertainty, and a sensitivity analysis using an alternative adherence definition yielded nearly identical results. The analysis suggests that baseline hard drug use is linked to poorer immunologic and physical outcomes two years after HAART initiation, and that this pattern is not explained by the available adherence measure.

Several limitations may affect interpretation. Hard drug use and adherence were each measured at a single time point and dichotomized, limiting the ability to capture variation that may influence outcomes. Complete‑case analysis may introduce bias if missingness is related to unobserved characteristics associated with both exposure and outcomes. Important potential confounders such as socioeconomic factors, mental‑health conditions, or co‑occurring infections were not included. Finally, the results reflect the structure of the MACS cohort and may not generalize to other populations. These considerations should be taken into account when interpreting the magnitude and stability of the estimated associations.

# TODO - edit names in tables and reorder groupings
