...
*Table 1* summaries key variables in the final sample of 463 at baseline across baseline hard drug use. *Table 2* summarizes key variables at year 2 across baseline hard drug use. 
