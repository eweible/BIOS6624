...
ggsurvplot(fit_sex, data = dat_cc, xlab = "Years", ylab = "Stroke-free survival")
survdiff(surv_object ~ SEX, data = dat_cc)

## By diabetes
fit_diab <- survfit(surv_object ~ DIABETES, data = dat_cc)
ggsurvplot(fit_diab, data = dat_cc, xlab = "Years", ylab = "Stroke-free survival")
...
ggsurvplot(fit_bp, data = dat_cc, xlab = "Years", ylab = "Stroke-free survival")
