...
ggplot(male_heat, aes(x = SYSBP, y = AGE, fill = prob)) +
  geom_tile(color = "white") +
  facet_wrap(~ DIABETES, labeller = label_both) +
  scale_fill_gradient(low = "lightblue", high = "darkred",
                      name = "10-year risk (%)") +
  labs(title = "Male 10-year Stroke Risk",
       x = "Systolic BP",
       y = "Age") +
  theme_minimal()
...
ggplot(female_heat, aes(x = SYSBP, y = AGE, fill = prob)) +
  geom_tile(color = "white") +
  facet_wrap(~ DIABETES, labeller = label_both) +
  scale_fill_gradient(low = "lightblue", high = "darkred",
                      name = "10-year risk (%)") +
  labs(title = "Female 10-year Stroke Risk",
       x = "Systolic BP",
       y = "Age") +
  theme_minimal()
```
